...
def run_llt_filter(params, measurements, xk_init=None, Pk_init=None):
    ...
    states, trends, upper, lower, xk_rts, Pk_rts, Pk_bars, innovations = [], [], [], [], [], [], [], []
    ...
    return np.array(states), np.array(trends), np.array(upper), np.array(lower), xk, Pk, xk_rts, Pk_rts, Pk_bars, np.array(innovations)